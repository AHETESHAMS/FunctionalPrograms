...
public class SearchingAndSorting
{
	...
	public static void main(String[] args) {
	    ...
	    String []stringSortArray = new String[] {"fig","orange","banana","apple","berry","mango"};
	    System.out.println();
	    ...
	    String []stringInsertionSortArray = new String[] {"fig","orange","banana","apple","berry","mango"};
	    System.out.println();
	    ...
	    stringInsertionSortArray = Utility.insertionSort(stringSortArray);
	    ...
	    System.out.println();
	    /*Insertion Sort Function*/
	    integerInsertionSortArray = Utility.insertionSort(stringSortArray);
